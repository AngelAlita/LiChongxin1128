...
import com.LiChongxin.model.Item;
import com.LiChongxin.model.Order;
import com.LiChongxin.model.Payment;
...
public class OrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            double orderTotal = request.getParameter("orderTotal") !=null?Double.parseDouble(request.getParameter("orderTotal")):0;
            ...
            address1 == null || address1.trim().length()==0||postalCode==null || postalCode.trim().length()==0){
                ...
                List<Payment> paymentsTypeList = Payment.findAllPayment(con);
                String path = "/WEB-INF/views/oder.jsp";
                request.getRequestDispatcher(path).forward(request,response);
            }
